...
contract EducationalID is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    struct Credential {
        string holderName;
        string institution; // University or School name
        string course; // E.g., "B.Sc. Computer Science", "MBA", "High School Diploma"
        string yearOfPassing;
        string grade; // E.g., "A", "85%", "First Class"
    }
    ...
    // SBT can have many issuers - modifiers removed for testing
