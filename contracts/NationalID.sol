...
contract NationalID is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    struct Credential {
        uint256 id; // Unique 12-digit number
        string holderName;
    ...
    function issueCredential(
        ...
        string memory gender, // Male, Female, Other
        ...
        credentials[tokenId] = Credential(id, holderName, gender, dateOfBirth);
